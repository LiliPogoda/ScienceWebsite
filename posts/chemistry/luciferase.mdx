...
1. $\text{Luciferase} + \text{ATP-Mg}^+ + \text{luciferin} \to \text{Luciferase} + \text{LH}_2\text{-AMP} + \text{PP}_i-\text{Mg}^+$

In the first step the firefly luciferase catalyses the reaction of luciferin(D-LH2) and Adenosintriphosphate (ATP). That forms Luciferyl adenylate (LH2-AMP).
