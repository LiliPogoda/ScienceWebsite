...
The protein structure consists of two compact domains: a larger N-terminal domain and a smaller C-terminal domain.
They are linked by a flexible linker peptide. The aminoacids of the two domains that face each other in the cleft are conserved in the family superfamily of adenylate forming enzymes.
