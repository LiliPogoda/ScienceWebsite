...
This is due to loss of their natural habitat, pesticides and light pollution. (I am quite saddened by this thought, as...) <del>This thought is quite saddening as</del> they and especially their ability to glow was always something that <del>kept me wondering</del> (amazed, bewildered, astonished) when I was small.
...
Fireflies are the most well-known and studied bioluminescent organisms. Responsible for the light production is a special enzyme-substrate system: The firefly Luciferase (enzyme) and the Luciferin (substrate). (TODO: do i have to explain substrate and enzyme? - Yes Please!)
...
The protein structure consists of two compact domains: a larger N-terminal domain and a smaller C-terminal domain linked through a flexible linker peptide. Feel free to explore this in (Fig.2) above.
Luciferase is part of the adenylate forming superfamily of enzymes. In this superfamily, the amino acids of the two domains that face each other in the cleft are conserved(TODO: explain).
(The conservation)<del>This</del> is a strong pointer that the cleft is the active site of the protein where the actual catalytic reaction takes place. The cleft (as you can see in the model) seems far too big for simultaneous interactions between the residues on both sides and the substrates.
