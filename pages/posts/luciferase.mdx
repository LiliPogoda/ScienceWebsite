...
Auch wenn weniger Magie involviert ist als mein jüngeres Ich vermutete, ist der chemische Prozess doch bezaubernd:
Bioluminiszenz - Das Produzieren und Abgeben von Licht durch lebende Organismen.

Glühwürmer sind die bekanntesten und meist-studierten bioluminiszenten Organismen. Verantwortlich für das Licht ist ein spezielles Enzym-Substrat System: Glühwurm Luciferase (Enzym) und Luciferin (Substrat).
Enzyme sind Proteine die als katalysatoren für biochemische Reaktionen dienen: Sie beschleunigen die Reaktion, ohne sie grundlegend zu verändern. Das Molekül, welches hierbei verwandelt wird ist das Substrat.
In unserem Fall katalysiert das Enzym die Umwandlung von Luciferin in einen oxidierten, erregten Zustand. In der Chemie wird von einem erregten Zustand gesprochen, wenn sich die Elektrone auf einem höheren Energie level befinden.
