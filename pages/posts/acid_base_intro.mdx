...
What exactly does the pH- scale tell us? All these questions will get answered in the acid and base series.
...
The Arrehnius definition states that acids are compounds that increase proton concentration in solutions and the Bases are compounds that increase hydroxideconcentration in solutiuons. Hence Arrehniusacids always contain hydrogen and arrehnius bases always contain hydroxidegroups.
(TODO: explanation of other theries more in depth?or extra article)

According to the Lewis model Acids are electronpair acceptors and Bases are electron acceptors. For a more in depth discussion of the Lewis model click here(TODO)
...
export default ({ children }) => (
  <LayoutPostWrapper pageIdx={1} title="Acid & Base chemistry: An introduction" date="2022-08-23">
    {children}
  </LayoutPostWrapper>
)
