...
The midpoint of the titration is reached when 50% of the NaOH solution have been added. At this point HAc is 50% disassociated. The concentration of [$HAc$] is equals [$Ac^-$]. 
The interesting thing about the midpoint is that it tells you the $pK_a$ of the the acid. And a little algebra will show you why:
...
$pK_a = pH$ TODO exercise with numbers and solution

After that NaOH is still continuously added in small portions until HAc is completely dissociated.
All its H+ ave reacted with the added OH- to H2O.

TODO give formulas for calculating pH???

There is something else really interesting about the titration curve, to be more precise about the midpoint where we have equal concentrations of the conjugate acid-base pair.
What exactly the gist is with that midpoint will be the matter of the next article of the acid base series.
